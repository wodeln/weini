...
export async function getCurrentPosition() {
  ...
  let payload={
      user_id:lstore.getData("H5_CUR_USER").id,
      formatted_address:data.formattedAddress,
      adcode:data.addressComponent.adcode,
      building:data.addressComponent.building,
      ...
      street_number:data.addressComponent.streetNumber,
  }
  api.post("/user/position",payload);
  return {
